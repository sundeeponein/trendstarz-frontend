        ...
        if (this.form) {
          ...
          try {
            const patch: any = {
              ...
              shootLocationMapUrl: newCampaign.shootLocationMapUrl || '',
              shootLocationNotes: newCampaign.shootLocationNotes || '',
              venueName: newCampaign.venueName || '',
              venueAddress: newCampaign.venueAddress || newCampaign.shootLocationAddress || '',
              venueCity: newCampaign.venueCity || '',
              venueDistrict: newCampaign.venueDistrict || '',
              venueState: newCampaign.venueState || '',
              venueGoogleMapUrl: newCampaign.venueGoogleMapUrl || newCampaign.shootLocationMapUrl || '',
              payToJoinBenefits: newCampaign.payToJoinBenefits || '',
              payToJoinInstructions: newCampaign.payToJoinInstructions || '',
              productValue: (function(paise: number){ return paise > 0 ? Math.floor(paise / 100) : null; })(Number(newCampaign.productValue || 0)),
              productDescription: newCampaign.productDescription || '',
              productPaymentMode: newCampaign.productPaymentMode || 'product_only',
              productPaymentAmount: (function(paise: number){ return paise > 0 ? Math.floor(paise / 100) : null; })(Number(newCampaign.productPaymentAmount || 0)),
              productShippingRequired: !!newCampaign.productShippingRequired,
              inviteBenefits: newCampaign.inviteBenefits || '',
              promotionUrlType: newCampaign.promotionUrlType || '',
              promotionUrl: newCampaign.promotionUrl || '',
              suggestedCaption: newCampaign.suggestedCaption || '',
