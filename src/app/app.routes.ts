...
export const routes: Routes = [
    ...
    component: NavbarLayoutComponent,
		children: [
			...
			{ path: 'photographer/:id', loadComponent: () => import('./shared/user-profile/photographer-profile-view/photographer-profile-view.component').then(m => m.PhotographerProfileViewComponent) },
